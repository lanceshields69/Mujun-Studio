...
// ai-native-designer-phase-one/index.html is hand-approved and must never
// be regenerated by this script (see main()) — it stays byte-identical.
const PROTECTED_SLUGS = ['ai-native-designer-phase-one'];
