<!-- hero image: article-img-how-i-use-ai.webp -->

# 私のAIの使い方

#### AIでデザインすることを学び、そしてAIそのものをデザインすることを学ぶ。
...
AIを活用し、バイブコーディングで制作した個人プロジェクト「Ship Yourself Cards」アプリについては、こちらをご覧ください：[https://www.lanceshields.design/lab](https://www.lanceshields.design/lab)
